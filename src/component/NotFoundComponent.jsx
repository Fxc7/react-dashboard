         ...
         <div className="relative h-screen overflow-hidden bg-base-200">
            ...
            <div className="container relative z-10 flex items-center px-6 py-32 mx-auto md:px-12 xl:py-40">
               <div className="relative z-10 flex flex-col items-center w-full font-mono">
                  ...
                  <Button type="button" className="btn btn-ghost font-acme rounded-btn px-20 mt-10" onClick={() => window.open('/', '_parent')}>Back homepage</Button>
                  <p className="font-extrabold font-luckiest text-base-content text-8xl my-20 animate-bounce">404</p>
               </div>
            </div>
         </div>
      </React.Fragment>
